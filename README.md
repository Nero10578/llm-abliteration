...
python refusal_circuit_scanner.py -m <model> --measurements <measurements_file> -o <output_dir> --start 30 --end 40
```

See [REFUSAL_CIRCUIT_SCANNER.md](REFUSAL_CIRCUIT_SCANNER.md) for detailed documentation.
